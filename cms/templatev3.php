...
<head>
	...
	<meta name="author" content="KSI ViceCaptain"> 
...
<div id="container">
  ...
  <ul id="navigation">
            ...
            <li><a href="http://www.realitydynasty.com">RD Home</a></li>
            <li><a href="http://forum.realitydynasty.com">RD Forums</a></li>
<li><a href="index.php?db=RDmembers">clan Leaders</a></li>
...
<h1 id="banner"></h1>
	<div id="content">
		<div id="left">
			...
			echo 'Total Members: <b>'.mysql_num_rows($q_stat_a).'</b>';
...
s
		...
		<div id="right">
			<!-- Start a side box -->
            <div class="side_header">Random RD Member</div>
			...
			<div class="side_content_menu"><a href="http://forum.realitydynasty.com" target="_blank"><img src="imgs/Forumslogo.gif" alt="clan Forums" border="0" /></a>			</div>
		  <!-- End a side box -->
		</div>
	</div>
	<div id="site_footer">Programming by: Matt lo, Reprogramming:Collin</div>
</div>
<div id="footer"><center class="style1">
  <span class="style1">&copy;2008-<?=date('Y')+1 ?> RD CLAN</span>
</center>
</div>
</body>
</html>